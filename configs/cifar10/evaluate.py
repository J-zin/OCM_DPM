...
def get_evaluate_config(**hparams):
    ...
    elif hparams['method'] == 'pred_eps_hesest_pretrained':
        config.models.model = get_iddpm_unet_config(**hparams)
        config.wrapper = default.get_dt_wrapper_config(typ='epshesest', **hparams)
    ...
    if hparams['method'] in ['pred_eps', 'pred_x0', 'pred_eps_eps2', 'pred_eps_epsc', 'pred_eps_iddpm',
                             'pred_eps_hesest_pretrained', 'pred_eps_hes_pretrained', 'pred_eps_eps2_pretrained', 'pred_eps_epsc_pretrained',
